...
feature_variances = pd.DataFrame(X_train, columns=X.columns).var()
...
selected_features_var_thresh = X.columns[var_thresh.get_support()]
print("Selected Features (Variance Threshold):", selected_features_var_thresh)

accuracy_var_thresh = accuracy_score(y_test, y_pred_var_thresh)
print("Accuracy (Variance Threshold Selected Features): ", accuracy_var_thresh)
...
print(f"Accuracy with Variance Threshold Selected Features: {accuracy_var_thresh:.4f}")
print(f"Accuracy with Correlation-Based Selected Features: {accuracy_corr:.4f}")
print(f"Accuracy with RFE Selected Features: {accuracy_rfe:.4f}")
print(f"Accuracy with Lasso Regularization Selected Features: {accuracy_lasso:.4f}")
